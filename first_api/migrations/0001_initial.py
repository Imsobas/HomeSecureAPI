    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gen_user_type', models.CharField(choices=[('Villager', 'Villager'), ('Manager', 'Manager'), ('Caretaker', 'Caretaker')], max_length=100)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secure_type', models.CharField(choices=[('SecureBoss', 'SecureBoss'), ('Enter', 'Enter'), ('Exit', 'Exit'), ('Inside', 'Inside')], max_length=100)),
                ...
                ('secure_current_location', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True)),
                ...
                ('secure_work_shift', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='first_api.work')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_user_lat', models.DecimalField(blank=True, decimal_places=8, max_digits=11, null=True)),
                ('qr_user_lon', models.DecimalField(blank=True, decimal_places=8, max_digits=11, null=True)),
